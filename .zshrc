...
# plugins=( # Couldn't get command-not-found working.
#   colored-man-pages # It's easier to see color than bolding and italics.
#   git
#   history
#   macos
#   npm
...
# # Some extensions need to be configured before sourcing oh my zsh (as $ZSH_CUSTOM doesn't exist yet).

# # nvm

# zstyle :omz:plugins:nvm lazy yes # Defer nvm loading
